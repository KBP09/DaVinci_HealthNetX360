    ...
    <div className='z-50 flex h-[70px] bg-white items-center justify-between px-8 fixed top-0 w-full border-b-2 border-slate-300'>
      ...
      <div className='flex gap-2 items-center'>
        <ul className='flex gap-12 mr-4'>
          ...
          <Link to='/landing'><li className='cursor-pointer hover:text-blue-500'>landing</li></Link>
          <Link to='/login'><li className='cursor-pointer hover:text-blue-500'>login</li></Link>
        </ul>
